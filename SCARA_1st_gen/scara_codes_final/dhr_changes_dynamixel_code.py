...
arduino = startup('/dev/tty.usbmodem14211')
...
def dhr_test():
    dhr_write(0x01,0x00,0x00,0xff,0x03)
    time.sleep(3)
    dhr_write(0x01,0x0ff,0x0f,0xff,0x03)
    time.sleep(3)
    dhr_write(0x02,0x00,0x00,0xff,0x03)
    time.sleep(3)
    dhr_write(0x02,0x0ff,0x0f,0xff,0x03)
def ping() :
